...
file_path = '/home/rody/Documents/mcse_module08-main/conn.log.labelled.txt'
...
# Step 6: Train the model (One test run)
print("Training the model...")
num_epochs = 1  # Change to 1 for a single test run
...
# Save the model
model_save_path = '/home/rody/Documents/mcse_module08-main/model.pth'
